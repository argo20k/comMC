...
# # Family Reunion
execute as @a[gamemode=!spectator] at @s if entity @e[type=husk,tag=!bac_baby,distance=..10] if entity @e[type=zombie_villager,tag=!bac_baby,distance=..10] if entity @e[type=drowned,tag=!bac_baby,distance=..10] if entity @e[type=zombified_piglin,tag=!bac_baby,distance=..10] if entity @e[type=zombie,tag=!bac_baby,distance=..10] if entity @e[type=husk,tag=bac_baby,distance=..10] if entity @e[type=zombie_villager,tag=bac_baby,distance=..10] if entity @e[type=drowned,tag=bac_baby,distance=..10] if entity @e[type=zombified_piglin,tag=bac_baby,distance=..10] if entity @e[type=zombie,tag=bac_baby,distance=..10] run advancement grant @s only blazeandcave:monsters/family_reunion
