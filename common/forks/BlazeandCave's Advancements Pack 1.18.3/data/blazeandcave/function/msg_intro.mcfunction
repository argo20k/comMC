...
tellraw @s {"color":"aqua","italic":false,"translate":"","extra":[{"text":" "},{"text":"/function blazeandcave:config_menu","click_event":{"action":"suggest_command","command":"/function blazeandcave:config_menu"}}]}
tellraw @s {"text":" "}
tellraw @s {"color":"#D1FFFD","italic":false,"translate":"Want to keep up with updates to the Advancements Pack? Join my","extra":[{"text":" "},{"color":"blue","italic":false,"underlined":true,"translate":"Discord","click_event":{"action":"open_url","url":"https://discord.gg/GBMSmWg"}},{"text":" "},{"translate":"and give yourself the Advancement Pack Squad in #roles!"}]}
